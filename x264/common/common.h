...
struct x264_t
{
	...
	pthread_mutex_t thread_mutex_start;	// 1 per Thread / Slice
	pthread_cond_t  thread_cond_start;		// 1 per Thread / Slice
	pthread_mutex_t thread_mutex_stop;		// 1 per Thread / Slice
	pthread_cond_t  thread_cond_stop;		// 1 per Thread / Slice
	int  b_thread_finished;						// 1 per Thread / Slice
	int  b_thread_ready;						// 1 per Thread / Slice
